    ...
    <div className="app">
      ...
      <div className='containe'>
        <div className='heading_text'>
          <h1 className='heading_one'>Loan Calculator</h1>
        </div>
        ...
        <div className='total_amount_card'>
          <div className='card_text '>
          <h3 className='total_amount_heading'>₹ {(Add)+parseInt(num1)}</h3>
          <p className='total_amount_para'>Total Amount to be paid with Interest</p>
          </div>
        </div>
        </form>
